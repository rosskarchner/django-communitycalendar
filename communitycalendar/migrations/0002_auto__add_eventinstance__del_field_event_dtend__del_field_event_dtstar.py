...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'communitycalendar_eventinstance', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['communitycalendar.Event'])),
            ('dtstart', self.gf('django.db.models.fields.DateTimeField')()),
            ('end_time', self.gf('django.db.models.fields.TimeField')()),
        ))
        db.send_create_signal(u'communitycalendar', ['EventInstance'])

        # Deleting field 'Event.dtend'
        db.delete_column(u'communitycalendar_event', 'dtend')

        # Deleting field 'Event.dtstart'
        db.delete_column(u'communitycalendar_event', 'dtstart')


    def backwards(self, orm):
        # Deleting model 'EventInstance'
        db.delete_table(u'communitycalendar_eventinstance')

        # Adding field 'Event.dtend'
        db.add_column(u'communitycalendar_event', 'dtend',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Event.dtstart'
        raise RuntimeError("Cannot reverse this migration. 'Event.dtstart' and its values cannot be restored.")
