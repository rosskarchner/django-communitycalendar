...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.recurrence_of'
        db.add_column(u'communitycalendar_event', 'recurrence_of',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['communitycalendar.Event'], null=True),
                      keep_default=False)

        # Adding field 'Event.recurrence_for_date'
        db.add_column(u'communitycalendar_event', 'recurrence_for_date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.recurrence_of'
        db.delete_column(u'communitycalendar_event', 'recurrence_of_id')

        # Deleting field 'Event.recurrence_for_date'
        db.delete_column(u'communitycalendar_event', 'recurrence_for_date')
